...
def generate_calendar():
    url = "https://gamesdonequick.com/schedule/48"
    ...
    events = soup.find_all(
        "div", class_="relative text-black/80 dark:text-white/90 flex flex-col lg:flex-row lg:items-stretch lg:border-none rounded-sm")
